...
extension Color {
    static func bgAbyss(for scheme: ColorScheme) -> Color {
        scheme == .dark ? Color(hex: "#121111") : Color(hex: "#F4F6F0")
    }
    ...
    static func bioGlow(for scheme: ColorScheme) -> Color {
        scheme == .dark ? Color(hex: "#E36B61") : Color(hex: "#D06C63")
    }
    
    static func bioluminPink(for scheme: ColorScheme) -> Color {
        scheme == .dark ? Color(hex: "#C7D0C5") : Color(hex: "#D7DED4")
    }
    
    static func deepViolet(for scheme: ColorScheme) -> Color {
        scheme == .dark ? Color(hex: "#232120") : Color(hex: "#E7EEE2")
    }
    ...
    static func bioTextSecondary(for scheme: ColorScheme) -> Color {
        scheme == .dark ? Color(hex: "#C7CCC2").opacity(0.74) : Color(hex: "#667065").opacity(0.76)
    }
}
        ...
        content
            ...
            .background {
                RoundedRectangle(cornerRadius: cornerRadius)
                    ...
                    .background(colorScheme == .dark ? .ultraThinMaterial : .thinMaterial, in: RoundedRectangle(cornerRadius: cornerRadius))
            }
            .overlay {
...
struct BioluminescentButtonStyle: ButtonStyle {
    ...
    func makeBody(configuration: Configuration) -> some View {
        let kind: GlassButtonStyle.Kind = isProminent ? .primary : .secondary
