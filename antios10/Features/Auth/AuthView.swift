        ...
        ZStack {
            ...
            ScrollView(showsIndicators: false) {
                ...
                VStack(spacing: 14) {
                    ...
                    HStack(spacing: 8) {
                        AuthContextPill(text: "Max Ready", tint: .liquidGlassAccent)
                        AuthContextPill(text: "Secure Sync", tint: .statusSuccess)
                    }
                }
...
private struct AuthContextPill: View {
    let text: String
    let tint: Color
...
private struct AuthSignalCard: View {
    let title: String
    let value: String
    let tint: Color
