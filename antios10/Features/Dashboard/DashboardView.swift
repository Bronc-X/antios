...
struct DashboardView: View {
        ...
        return LiquidGlassCard(style: .elevated, padding: 16) {
            VStack(alignment: .leading, spacing: 14) {
                ...
                HStack(alignment: .center, spacing: 12) {
                    ZStack {
                        ...
                        Circle()
                            ...
                            .stroke(
                                LinearGradient(
                                    colors: [Color.liquidGlassAccent, Color.liquidGlassFreshGreen],
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        dashboardHeroMetric(
                            title: t("闭环完成", "Loop completion"),
                            value: "\(Int(loopProgress * 100))%",
                            accent: .liquidGlassAccent
                        )
                        dashboardHeroMetric(
                            title: t("当前优先级", "Current priority"),
                            value: r(viewModel.antiAnxietyLoopStatus.currentStep.title),
                ...
                HStack(spacing: 6) {
                    ...
                    dashboardInlineBadge(
                        title: t("允许中断再继续", "Pause and resume"),
    ...
    private func explanationRow(title: String, value: String) -> some View {
        ...
        .overlay(
            RoundedRectangle(cornerRadius: 12, style: .continuous)
                .stroke(Color.white.opacity(colorScheme == .dark ? 0.06 : 0.16), lineWidth: 1)
        )
        .clipShape(RoundedRectangle(cornerRadius: 12))
    }
    ...
    private func dashboardHeroMetric(title: String, value: String, accent: Color) -> some View {
        VStack(alignment: .leading, spacing: 3) {
            Text(title)
                .font(.caption2.weight(.semibold))
                .foregroundColor(.textTertiary)
    ...
    private func dashboardInlineBadge(title: String, systemImage: String, tint: Color) -> some View {
        HStack(spacing: 6) {
